...
export default function HeroBanner({
  ...
  return (
    <section
      id="hero"
      className="-mt-18 relative w-full h-screen bg-[url('/images/main-hero.jpg')] bg-cover bg-center bg-no-repeat bg-fixed px-6 text-center"
    >
      <div className="absolute inset-0 bg-black/40 backdrop-blur-sm">
        <div className="relative z-10 max-w-4xl mx-auto py-64 text-white">
          ...
          <div className="mb-10">
            <BaseButton className="bg-white">{buttonName}</BaseButton>
          </div>
